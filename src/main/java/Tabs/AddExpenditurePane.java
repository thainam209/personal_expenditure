...
public class AddExpenditurePane extends javax.swing.JPanel {
    ...
    public AddExpenditurePane(MainFrame main) {
        this.main=main;
    ...
    public AddExpenditurePane(MainFrame main,String id) {
        this.main=main;
    ...
    private void loadById(String Id){
        try {
            ...
            String date = du.toString(entity.getExpenditureDate());
    ...
    private void initComponents() {
        ...
        lbExpenditureDate = new javax.swing.JLabel();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lbExpenditureDate, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(lbExpenditureDate, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(28, 28, 28)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel6)
                ...
                if(txtName.getText().equals("")) lbName.setText("Hãy nhập tên !");
                    ...
                    if(ftfAmount.getText().equals("")) lbAmount.setText("Hãy nhập số lượng !");
                        ...
                        try{
                            ...
                            lbExpenditureDate.setText("");
                            if(ftfDate.getText().equals("")) lbExpenditureDate.setText("Hãy nhập ngày chi tiêu !");
                            else{
                                try {
                                    lbExpenditureDate.setText("");
                                    DateUtil du = new DateUtil();
                                    Date ExpenditureDate = du.toDate(ftfDate.getText());
                                    
                                    entity.setID(txtID.getText());
                                    entity.setName(txtName.getText());
                                    entity.setAmount(amount);
                                    
                                    ExpenditureType ext = (ExpenditureType)cboType.getSelectedItem();
                                    
                                    entity.setIDType(ext.getId());
                                    entity.setExpenditureDate(ExpenditureDate);
                                    ...
                                    lbExpenditureDate.setText("Ngày chi tiêu không hợp lệ!");
                                }
//                                
                        }
    ...
    private javax.swing.JComboBox<ExpenditureType> cboType;
    ...
    private javax.swing.JLabel lbExpenditureDate;
