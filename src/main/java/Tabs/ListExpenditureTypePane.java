...
public class ListExpenditureTypePane extends javax.swing.JPanel {
    ...
    public ListExpenditureTypePane(MainFrame main) {
        this.main = main;
        initComponents();
        initTable();
        loadData();
        //Thiết lập chế độ chọn cho bảng
        tblListExpenditureType.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION); // Cho phép chọn nhiều hàng
    }
    ...
    private void initTable(){
       ...
       //Hiển thị thông tin
       tblListExpenditureType.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        tblListExpenditureType = new javax.swing.JTable();
        ...
        jLabel1.setText("LIỆT KÊ LOẠI CHI TIÊU");

        tblListExpenditureType.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tblListExpenditureType.setComponentPopupMenu(ppmList);
        jScrollPane1.setViewportView(tblListExpenditureType);
    ...
    private void ppmDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppmDeleteActionPerformed
        try {
            if(JOptionPane.showConfirmDialog(this, "Bạn có thực sự muốn xóa", "",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
            {
                ...
                int selectedRow = tblListExpenditureType.getSelectedRow();
                
                //Lấy ID của hàng đó
                Object IdObject = tblListExpenditureType.getValueAt(selectedRow, 0);
                if(IdObject != null) {
    ...
    private void ppmUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppmUpdateActionPerformed
        try {
                ...
                if(IdObject != null) {
                    String id = IdObject.toString();
                    main.showUpdateExpenditureType(id);
                }   
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Không tìm thấy loại khoản chi","Thông báo",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            if(JOptionPane.showConfirmDialog(this, "Bạn có thực sự muốn xóa", "",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
            {
                int[] selectedRows = tblListExpenditureType.getSelectedRows();

                for (int row : selectedRows) {
                    //Lấy id của các hàng đã chọn
                    String id = tblListExpenditureType.getValueAt(row, 0).toString();
...
//            System.out.println("Lỗi:"+ex.getMessage());
    ...
    private javax.swing.JTable tblListExpenditureType;
