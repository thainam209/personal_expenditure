...
public class AddExpenditureTypePane extends javax.swing.JPanel {
    ...
    public AddExpenditureTypePane(MainFrame main) {
        this.main = main;
        initComponents();
    ...
    public AddExpenditureTypePane(MainFrame main, String Id) {
        this.main = main;
        initComponents();
        btnUpdate.setEnabled(false);
        btnDelete.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("THÊM MỚI LOẠI CHI TIÊU");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ExpenditureType enity = new ExpenditureType();
