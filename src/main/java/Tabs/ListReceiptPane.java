...
public class ListReceiptPane extends javax.swing.JPanel {
    ...
    public ListReceiptPane(MainFrame main) {
        this.main=main;
        initComponents();
        ...
        tblListReceipt.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION); // Cho phép chọn nhiều hàng
    }
    ...
    private void initTable(){
       ...
       model.setColumnIdentifiers(new String[]{"ID","Name","Amount","IDType","Note","ReceiptDate"});
       //Hiển thị thông tin
       tblListReceipt.setModel(model);
    }
    
    private void loadData(){
        try {
            ReceiptDao dao = new ReceiptDao();
            List<Receipt> list = dao.findAll();
            ...
            for (Receipt item : list) {
                ...
                String date = du.toString(item.getReceiptDate());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LIỆT KÊ NGUỒN THU");
        ...
        tblListReceipt.setComponentPopupMenu(ppmList);
    ...
    private void ppmUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppmUpdateActionPerformed
        try {  
                ...
                int selectedRow = tblListReceipt.getSelectedRow();
                
                //Lấy ID của hàng đó
                Object IdObject = tblListReceipt.getValueAt(selectedRow, 0);
                if(IdObject != null) {
                    String id = IdObject.toString();
                    main.showUpdateReceipt(id);
                }   
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            if(JOptionPane.showConfirmDialog(this, "Bạn có thực sự muốn xóa", "",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION)
            {
                int[] selectedRows = tblListReceipt.getSelectedRows();
                
                for (int row : selectedRows) {
                    //Lấy id của các hàng đã chọn
                    String id = tblListReceipt.getValueAt(row, 0).toString();
